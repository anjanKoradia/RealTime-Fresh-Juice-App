...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n            <p>".concat(menuItem.item.name, "(").concat(menuItem.item.quantity, ") - ").concat(menuItem.qty, " </p>\n        ");
    }).join("");
  }
...
function updateCart(juice) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", juice).then(function (res) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ manageItemQty)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* ---------------------------------------- 
...
function manageItemQty() {
  ...
  increaseQtyBtn.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("/cart/increase-qty/".concat(juice.item._id)).then(function (res) {
        btn.previousElementSibling.innerText = res.data.cart.items[juice.item._id].qty;
        setValues(res);
      });
    });
  ...
  decreaseQtyBtn.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      var juice = JSON.parse(btn.dataset.cartjuice);
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("/cart/decrease-qty/".concat(juice.item._id)).then(function (res) {
        btn.nextElementSibling.innerText = res.data.cart.items[juice.item._id].qty;
        setValues(res, juice);
      });
    });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfresh_juice"] = self["webpackChunkfresh_juice"] || [];
